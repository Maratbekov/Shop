    ...
    return (
        <div className="basis-1/3 p-2">
            <div className="w-full max-w-sm bg-black rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
                <Link to={`/products/detail-page/${el.id}`}>
                ...
                <div className="px-5 pb-5">
                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <span>
                                                  <AiFillHeart onClick={()=> dispatch(addToWishlist(el))} style={{color: "white",fontSize:"30px", marginLeft:"80px"}} className="border rounded-lg" />
